...
## Approved M11 hard save

The promoted M11 baseline adds a deterministic 25-endpoint/21-oscillator qualification fixture, a real-browser 25-position journey, repeated cleanup/rebuild cycles, sustained digital 10×/100× overload tests, stereo max-channel peak coverage, reset acknowledgement, MessagePort lifecycle, worklet fail-closed, invalid-control, active-deletion, and resource-balance checks. `milestone/ui-interaction-harness` is authoritative through M11; `review/m10-safety-audit` remains historical review evidence.
